                ...
                <div className="container">
                    <div className="box card p-3 show border-0">
                        ...
                        <form className="mt-3">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group">
                                        <TextField type="txet" label="Name"
                                            required variant="standard" className="w-100" />
                                    </div>
                                </div>
                                <div className="col-md-6">
                                <div className="form-group">
                                        <TextField type="txet" label="Phone No."
                                            required variant="standard" className="w-100" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <p className="txt">Not Resigter? <Link to="/signUp" className="border-effect cursor">Sign Up</Link>
                            </p>
